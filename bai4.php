...
for ($i=$so_dau;$i<=$so_cuoi;$i++) 
if ($i%2==0) 
$tong_chan=$tong_chan+$i; for ($i=$so_dau;$i<=$so_cuoi;$i++) 
if ($i%2!=0) 
$tong_le=$tong_le+$i; 
} 
...
(isset($_POST["so_cuoi"])) echo $_POST["so_cuoi"];?> "/></td> </tr> 
<tr> 
...
<tr> 
<td colspan="5"><input type="submit" name="button" id="button" value="Tính toán" /></td> </tr> 
</table> 
</form> 
</body> 
</html> 
